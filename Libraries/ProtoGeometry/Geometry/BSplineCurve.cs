...
namespace Autodesk.DesignScript.Geometry
{
    public class BSplineCurve : Curve
    {
        ...
        {
            RegisterHostType(typeof(IBSplineCurveEntity), (IGeometryEntity host, bool persist) => { return new BSplineCurve(host as IBSplineCurveEntity, persist); });
        }

        private BSplineCurve(IBSplineCurveEntity host, bool persist = false)
            : base(host, persist)
        {
        ...
        protected BSplineCurve(Point[] points, Vector startTangent, Vector endTangent, bool makePeriodic,bool persist)
        ...
        protected BSplineCurve(Point[] controlVertices, int degree, bool makePeriodic,bool persist)
        ...
        {
            return new BSplineCurve(controlVertices, degree, makePeriodic, true);
        }
        ...
        /// <returns>BSplineCurve</returns>
        public static BSplineCurve ByPoints(Point[] points)
        {
        ...
        /// <param name="makePeriodic">Flag to make it periodic</param>
        /// <returns>BSplineCurve</returns>
        public static BSplineCurve ByPoints(Point[] points, bool makePeriodic)
        {
        ...
        /// <param name="makePeriodic">Flag to make it periodic</param>
        /// <returns>BSplineCurve</returns>
        private static BSplineCurve ByPoints(Point[] points, Vector startTangent, Vector endTangent, bool makePeriodic)
        {
            return new BSplineCurve(points, startTangent, endTangent, makePeriodic, true);
        }
        ...
        private static IBSplineCurveEntity ByControlVerticesCore(Point[] controlVertices, ref int degree, bool makePeriodic)
        {
        ...
        private static IBSplineCurveEntity ByPointsCore(ref Point[] points, Vector startTangent, Vector endTangent, bool makePeriodic)
        {
