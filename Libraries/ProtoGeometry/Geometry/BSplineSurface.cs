...
namespace Autodesk.DesignScript.Geometry
{
    ...
    public class BSplineSurface : Surface
    {
        ...
        {
            RegisterHostType(typeof(IBSplineSurfaceEntity), (IGeometryEntity host, bool persist) => { return new BSplineSurface(host as IBSplineSurfaceEntity, persist); });
        }

        internal BSplineSurface(IBSplineSurfaceEntity host, bool persist = false)
            : base(host, persist)
        {
        ...
        protected BSplineSurface(Point[][] controlVertices, int uDegree, int vDegree,bool persist)
            : base(ByControlVerticesCore(controlVertices, ref uDegree, ref vDegree),persist)
        {
            InitializeGuaranteedProperties();
        }

        protected BSplineSurface(Point[][] points, int uDegree, int vDegree, bool persist,bool unused)
        ...
        /// <returns></returns>
        public static BSplineSurface ByControlVertices(Point[][] controlVertices, int uDegree, int vDegree)
        {
            return new BSplineSurface(controlVertices, uDegree, vDegree, true);
        }
        ...
        /// <param name="vDegree">Degree in v direction</param>
        /// <returns></returns>
        public static BSplineSurface ByPoints(Point[][] points, int uDegree, int vDegree)
        {
            return new BSplineSurface(points, uDegree, vDegree, true, true);
        }
        ...
        /// <param name="points">Points through which the surface will pass</param>
        /// <returns></returns>
        public static BSplineSurface ByPoints(Point[][] points)
        {
        ...
        private static IBSplineSurfaceEntity ByControlVerticesCore(Point[][] controlVertices, ref int uDegree, ref int vDegree)
        {
            if (uDegree < 2)
                throw new System.ArgumentException(string.Format(Properties.Resources.LessThan, "uDegree", "two"), "uDegree");
            if (uDegree > 10)
