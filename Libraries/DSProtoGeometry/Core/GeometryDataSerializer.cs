...
namespace Autodesk.DesignScript.Geometry
{
    ...
    class GeometryDataSerializer : IGeometryDataCollection
    {
        ...
        static GeometryDataSerializer()
        {
            ...
            mSerializers.RegisterSerializers<IPointEntity>("DSPoint", (GeometryDataSerializer s) => s.ReadPoint("DSPoint"));
            mSerializers.RegisterSerializers<ICoordinateSystemEntity>("DSCoordinateSystem", (GeometryDataSerializer s) => s.ReadCoordinateSystem());
            mSerializers.RegisterSerializers<ILineEntity>("DSLine", (GeometryDataSerializer s) => s.ReadLine());
            mSerializers.RegisterSerializers<ICircleEntity>("DSCircle", (GeometryDataSerializer s) => s.ReadCircle());
            mSerializers.RegisterSerializers<IArcEntity>("DSArc", (GeometryDataSerializer s) => s.ReadArc());
            mSerializers.RegisterSerializers<IBSplineCurveEntity>("DSBSplineCurve", (GeometryDataSerializer s) => s.ReadBSplineCurve());
        }
        ...
        public IBSplineCurveEntity ReadBSplineCurve()
        {
            ...
            points.ForEach(DSGeometryExtension.DisposeObject);
            return entity;
        }
