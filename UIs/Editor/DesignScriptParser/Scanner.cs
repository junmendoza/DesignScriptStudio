	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 21:
				...
				if (ch <= 9 || ch >= 11 && ch <= 65535) {AddCh(); goto case 21;}
			...
			case 29:
				if (ch <= ')' || ch >= '+' && ch <= '.' || ch >= '0' && ch <= 65535) {AddCh(); goto case 22;}
