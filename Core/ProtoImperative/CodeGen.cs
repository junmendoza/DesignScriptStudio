...
namespace ProtoImperative
{
    ...
    public class CodeGen : ProtoCore.CodeGen
    {
        ...
        {
            return ProtoCore.DSASM.Constants.kForLoopKey + forloopCounter.ToString();
        }

        private string GetForExprIdent()
        {
            // TODO Jun: Should this be autogenerated or kept as a constant?
            return ProtoCore.DSASM.Constants.kForLoopExpression + forloopCounter.ToString();
        }
        ...
        private void EmitBreakNode(ProtoCore.AST.Node node)
        {
            ...
            else
            {
                if (localProcedure != null)
                {
                    compileStateTracker.BuildStatus.LogWarning(ProtoCore.BuildData.WarningID.kFunctionAbnormalExit, ProtoCore.BuildData.WarningMessage.kInvalidBreakForFunction , compileStateTracker.CurrentDSFileName, node.line, node.col);
                    EmitPushNull();
        ...
        private void EmitContinueNode(ProtoCore.AST.Node node)
        {
            ...
            else
            {
                if (localProcedure != null)
                {
                    compileStateTracker.BuildStatus.LogWarning(ProtoCore.BuildData.WarningID.kFunctionAbnormalExit, ProtoCore.BuildData.WarningMessage.kInvalidContinueForFunction, compileStateTracker.CurrentDSFileName, node.line, node.col);
                    EmitPushNull();
                    EmitReturnToRegister();
                }
            }
            ...
            ProtoCore.AST.Node setterArgument = null)
        {
            ...
            if (setterArgument != null)
            {
                ...
                {
                    compileStateTracker.BuildStatus.LogSyntaxError("Only identifier or identifier list can appear on the left hand side of assignment.", compileStateTracker.CurrentDSFileName, inode.RightNode.line, inode.RightNode.col);
                }
            }
            else
            {
        ...
        public String GetFunctionSignatureString(string functionName, ProtoCore.Type returnType, ArgumentSignatureNode signature, bool isConstructor = false)
        {
            ...
            functionSig.Append(":");
            functionSig.Append(compileStateTracker.TypeSystem.GetType(returnType.UID));
        ...
        {
            return (!InsideFunction()) && (ProtoCore.DSASM.ImperativeCompilePass.kGlobalScope == compilePass);
        }

        private bool IsParsingGlobalFunctionBody()
        {
            return (InsideFunction()) && (ProtoCore.DSASM.ImperativeCompilePass.kGlobalFuncBody == compilePass);
        }
        ...
        protected void EmitIdentifierListNode(ProtoCore.AST.ImperativeAST.ImperativeNode node, ref ProtoCore.Type inferedType, ProtoCore.AssociativeGraph.GraphNode graphNode = null, ProtoCore.AST.Node parentNode = null)
        {
            ...
            EmitIdentifierListNode(node, ref inferedType, false, graphNode, AssociativeSubCompilePass.kNone, parentNode);
            ...
            ProtoCore.DSASM.AssociativeSubCompilePass subPass = ProtoCore.DSASM.AssociativeSubCompilePass.kNone, ProtoCore.AST.Node parentNode = null)
        {
            ...
            {
                EmitExprListNode(node, ref inferedType, null, AssociativeSubCompilePass.kNone, parentNode);
            }
