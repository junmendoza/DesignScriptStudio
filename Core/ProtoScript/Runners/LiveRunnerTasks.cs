...
namespace ProtoScript.Runners
{
    public partial class LiveRunner
    {
        ...
        private class DynamoNodeValueRequestTask : Task
        {
        ...
        private class DynamoUpdateGraphTask : Task
        {
        ...
        private class DynamoConvertNodesToCodeTask : Task
        {
            private List<Subtree> subtrees;
            public DynamoConvertNodesToCodeTask(List<Subtree> subtrees, LiveRunner runner): base(runner)
            {
